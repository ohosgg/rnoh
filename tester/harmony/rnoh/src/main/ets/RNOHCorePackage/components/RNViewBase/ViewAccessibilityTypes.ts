// COPIED FROM: https://github.com/facebook/react-native/blob/main/packages/react-native/Libraries/Components/View/ViewAccessibility.d.ts
// TODO: Change when bumping React Native version
