import { Button, Keyboard, KeyboardAvoidingView, StyleProp, StyleSheet, Text, TextInput, TouchableWithoutFeedback, View, ViewStyle } from 'react-native';
  ...
  return (
    <TestSuite name="KeyboardAvoidingView">
      <TestCase itShould="don't avoid keyboard">
        <KeyboardAvoidingViewTestCase behavior='height' justifyContent='space-around' enabled={false} />
      </TestCase>
      <TestCase itShould="avoid keyboard by changing height">
        <KeyboardAvoidingViewTestCase behavior='height' justifyContent='space-around' />
      </TestCase>
      ...
      <TestCase itShould="avoid keyboard by changing padding">
        <KeyboardAvoidingViewTestCase behavior='padding' justifyContent='flex-end' />
      </TestCase>
    </TestSuite >
  );
};
...
function KeyboardAvoidingViewTestCase(props: KeyboardAvoidingViewTestCaseProps) {
    ...
    <Modal contentContainerStyle={{ height: '100%' }}>
      <KeyboardAvoidingView
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{ height: '100%', justifyContent: props.justifyContent }}>
            <TextInput placeholder="TextInput" style={styles.textInput} />
            <View style={{ height: 150, width: 150, backgroundColor: 'firebrick' }} />
            <View style={{ height: 150, width: 150, backgroundColor: 'beige' }} />
          </View>
