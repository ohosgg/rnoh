...
function UserInfo({ name, rank, avatar }) {
  return (
              ...
              >
                {pieceNameMaybe && (
                  <Image
                    ...
                    source={{ uri: PIECE_IMAGE_URI_BY_NAME[pieceNameMaybe] }}
                  />
                )}
              </ChessboardCell>
            );
...
function ChessboardCell({ variant, children, topLeftText, bottomRightText }) {
